...
considerando suas idades quando o livro foi lançado. Use MAP e SORT.
*/
function nameAndAge() {
  const objectBook = books.map(book => {
  ...
  return objectBook.sort((count, current) => count.age - current.age);
}
